...
sqlContext.sql("alter table aggr.users_value_by_links_current_ranking drop if exists partition (forum_name='" + forumName + "')");
...
sqlContext.sql("alter table aggr.users_popularity_current_ranking drop if exists partition (forum_name='" + forumName + "')");
sqlContext.sql("INSERT INTO aggr.users_popularity_current_ranking partition (forum_name)  "
+ " select  "
+ "  start.period_dte "
+ " ,ranking.user_id  "
+ " ,ranking.view_count "
